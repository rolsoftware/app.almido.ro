                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-10">
                                <input id="guard_name" name="guard_name" type="text" value="{{ old('guard_name','web') }}" class="form-control @error('guard_name') is-invalid @enderror" placeholder="">
                                @error('guard_name')
                                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                @enderror
                            </div>
        ...
        <div class="row justify-content-end">
            ...
            <div class="col-sm-9">
                <div class="text-sm-end">
                    <a href="{{ route('permission.index') }}" class="btn btn-secondary waves-effect waves-light"><i class="mdi mdi-close-circle-outline font-size-16 align-middle me-2"></i> Renunta</a>
                </div>
            </div>
        </div>
    </form>
